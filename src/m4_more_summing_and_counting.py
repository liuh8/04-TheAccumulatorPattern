...
def run_test_count_cosines_from():
    ...
    # Test 4:
    expected = 2
    answer = count_cosines_from(5, 14, 0.9)
    print('Test 4 expected:', expected)
    print('       actual:  ', answer)

    # Test 5:
    expected = 8
    answer = count_cosines_from(3, 15, -0.4)
    print('Test 5 expected:', expected)
    print('       actual:  ', answer)

    # Test 6:
    expected = 11
    answer = count_cosines_from(6, 23, -0.29)
...
def run_test_sum_unit_fractions_from():
    ...
    # Test 3:
    expected = 2.760  # This is APPROXIMATELY the correct answer.
    answer = sum_unit_fractions_from(4, 55)
